...
- (void)drawRect:(CGRect)rect
{
	...
	if (showAntialiasingWarning)
	{
		...
		NSLog(@"DCIntrospect-ARC: *** WARNING: One or more values of this view's frame are non-integer values. This view will likely look blurry. *** %@", NSStringFromCGRect(self.mainRect));
	}
	else
	{
